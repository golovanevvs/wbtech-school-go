...
- страница "Главная" (`/`):
  ...
  - кнопка "Добавить" -> переход на страницу "Добавление записи" (`/add_item`);
  - кнопка "Аналитика" -> переход на страницу "Просмотр аналитики" (`/analytics`);
...
- страница "Добавление записи" (`/add_item`):
  ...
  - поле "Дата";
  - поле "Сумма";
  - кнопка "Добавить запись" -> `POST /items`, если успех -> переход на страницу "Главная" (`/`), если неудача -> отображается сообщение об ошибке;
- страница "Просмотр аналитики":
  ...
  - форма для отображения аналитики:
    ...
    - кнопка "Скачать CSV" -> скачивание файла в формате CSV;
