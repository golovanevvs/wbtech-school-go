...
import (
	...
	"github.com/golovanevvs/wbtech-school-go/tree/main/L3/L3.7/warehouse-control/warehouse-control_main-server/internal/app"
...
func main() {
	...
	lg.Info().Msgf("%s warehouse-control_main-server started", pkgConst.AppStart)
