...
Необходимо реализовать функцию объединения done-каналов (описана в задаче 14 уровня 2). Проект хоть и небольшой, но концептуально важен: правильная работа с конкурентностью и каналами.
